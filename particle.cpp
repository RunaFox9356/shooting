...
void CParticle::Update()
{
	...
	SetPos(m_pos);
	SetColar(PositionVec4(myColor.r, myColor.g, myColor.b, myColor.a));
...
CParticle* CParticle::Create(const Info& inParticle, const D3DXVECTOR3& inPos)
{
	...
	if (particle == nullptr)
	{
		...
		particle->SetColar(PositionVec4(particle->m_data.color.colBigin.r, particle->m_data.color.colBigin.g, particle->m_data.color.colBigin.b, particle->m_data.color.colBigin.a));
