	...
	if (m_Move)
	{
		if (CInputpInput->Trigger(CInput::KEY_RIGHT))
		{
			...
			case 0:
				...
				break;
			case 1:
				SetColar(PositionVec4(0.8f, 0.0f, 0.8f, 1.0f));
				break;
			case 2:
				SetColar(PositionVec4(0.0f, 0.0f, 0.8f, 1.0f));
				
				break;
			case 3:
				SetColar(PositionVec4(0.0f, 0.8f, 0.8f, 1.0f));
				break;
			case 4:
				SetColar(PositionVec4(0.0f, 0.8f, 0.0f, 1.0f));
				break;
			case 5:
				SetColar(PositionVec4(0.0f, 0.8f, 0.8f, 1.0f));
				break;
			case 6:
				SetColar(PositionVec4(0.8f, 0.8f, 0.0f, 1.0f));
				break;
			default:
